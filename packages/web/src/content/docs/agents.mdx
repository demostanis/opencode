...
OpenCode comes with three built-in subagents, **General**, **Explore**, and **Security**. We'll look at these below.
...
A security assessment agent for authorized vulnerability research, penetration testing, and CTF-style targets. It reports proven Critical or High findings with concrete evidence, coordinates independent subagents for cross-checking on broader assessments, and stays within explicit authorization and safety boundaries.
